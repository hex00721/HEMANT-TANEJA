  ...
  return (
    <section className="relative py-24">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-[var(--rgb-primary)] neon-text mb-14">
          FEATURED CATEGORIES
        </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              className="group bg-zinc-900 border border-[var(--rgb-primary)] rounded-3xl p-5 sm:p-8 md:p-10 text-center shadow-[0_0_25px_var(--rgb-primary)] hover:scale-105 transition-all duration-300"
            >
